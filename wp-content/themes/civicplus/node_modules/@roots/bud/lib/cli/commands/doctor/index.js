...
`,
    ...
    async execute() {
        ...
        this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsx(Text, { color: "blue", children: "Mode" }), _jsx(Text, { children: this.bud.mode })] }));
        const configFiles = (this.bud.context.files ? Object.values(this.bud.context.files) : []).filter(({ bud }) => bud);
        if (configFiles.length) {
            this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "blue", children: ["Bud configuration files", `\n`] }), configFiles.map(({ name, path }, i) => (_jsxs(Box, { children: [_jsxs(Text, { children: [figures.triangleRightSmall, " ", name] }), _jsx(Text, { children: ` ` }), _jsx(Text, { dimColor: true, children: path.replace(this.bud.context.basedir, `.`) })] }, i)))] }));
        }
        else {
            this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "blue", children: ["Registered configurations", `\n`] }), _jsx(Text, { dimColor: true, children: "No configuration files found in project" })] }));
        }
        try {
            this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "blue", children: ["Config API calls", `\n`] }), _jsx(Text, {}), !this.bud.api.trace.length ? (_jsx(Text, { dimColor: true, children: "No config calls logged" })) : (this.bud.api.trace.map(([fn, args], i) => (_jsxs(Box, { flexDirection: "row", children: [_jsxs(Text, { children: [figures.triangleRightSmall, " ", fn] }), _jsx(Text, { children: ` ` }), _jsx(Text, { dimColor: true, children: args.map(this.bud.fs.json.stringify).join(`, `) })] }, i))))] }));
        }
        catch (error) {
        ...
        if (this.bud.env) {
            try {
                this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "blue", children: ["Environment", `\n`] }), this.bud.env.getEntries().map(([key, value]) => {
                            return (_jsxs(Box, { flexDirection: "row", children: [_jsx(Text, { children: figures.triangleRightSmall }), _jsx(Text, { children: ` ` }), _jsx(Text, { children: key }), _jsx(Text, { children: ` ` }), _jsx(Text, { dimColor: true, children: typeof value === `string` && value.length > 0
                                            ? `************`
                                            : typeof value })] }, key));
                        })] }));
            }
        ...
        if (this.enabledExtensions) {
            try {
                this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "blue", children: ["Enabled extensions", `\n`] }), this.mapExtensions(this.enabledExtensions)] }));
                this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsxs(Text, { color: "blue", children: ["Disabled extensions", `\n`] }), this.mapExtensions(this.disabledExtensions)] }));
            }
            catch (error) {
                this.renderStatic(_jsx(Error, { error: BudError.normalize(error) }));
            }
        ...
        if (this.mode === `development`) {
            this.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsx(Text, { color: "blue", children: "Development server" }), _jsxs(Box, { flexDirection: "row", children: [_jsx(Text, { children: "URL:" }), _jsx(Text, { children: this.bud.hooks
        ...
        try {
            ...
            this.renderStatic(_jsx(Box, { children: _jsxs(Text, { color: "green", children: [figures.tick, " webpack validated configuration"] }) }));
        }
        catch (error) {
            this.renderStatic(_jsx(Box, { children: _jsxs(Text, { color: "red", children: ["\u274C ", error?.message ?? error] }) }));
        }
    }
