        ...
        try {
            return (errors
                ...
                message: message
                    ...
                    .map(ln => ln.replaceAll(new RegExp(this.app.path().concat(sep), `g`), `.`))
                    /* Discard empty lines */
    ...
    async render(stats) {
        try {
            ...
            const App = process.stdout.isTTY && !this.app.isProduction
                ? Dashboard.TTYApp
                : Dashboard.App;
            render(_jsxs(Box, { flexDirection: "column", marginTop: 1, children: [_jsx(_Fragment, { children: _jsx(Console, { messages: this.app.consoleBuffer.fetchAndRemove() }) }), _jsx(App, { compilations: compilations.map(compilation => ({
                            ...compilation,
