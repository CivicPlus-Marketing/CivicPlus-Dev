...
export const Error = ({ error, ...props }) => {
    if (!error) {
        return (_jsxs(Ink.Box, { flexDirection: "column", children: [_jsx(Ink.Text, { children: "An unknown error has occurred." }), Object.entries(props).map(([key, value], id) => (_jsxs(Ink.Box, { flexDirection: "column", gap: 2, children: [_jsx(Ink.Text, { children: key }), _jsx(Ink.Text, { children: JSON.stringify(value) })] }, id)))] }));
    }
    if (isString(error)) {
