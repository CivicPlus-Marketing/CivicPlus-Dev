...
export type LifecycleMethods = 'boot' | 'buildAfter' | 'buildBefore' | 'configAfter' | 'make' | 'register';
/**
...
export interface Service extends BaseService {
    ...
    import<K extends `${keyof Modules}`>(signifier: K, fatalOnError: boolean, context: string): Promise<Extension>;
