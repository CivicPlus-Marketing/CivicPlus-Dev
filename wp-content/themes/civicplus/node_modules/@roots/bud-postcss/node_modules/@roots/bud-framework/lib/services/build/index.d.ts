import type { Configuration, Items, Loaders, Rules } from '@roots/bud-framework';
import type { Base } from './base.js';
import type { Item } from './item.js';
import type { Loader } from './loader.js';
import type { Rule, Options as RuleOptions, Output as RuleOutput } from './rule.js';
/**
 * Build Service
 *
 * @remarks
...
export interface Build {
     ...
     */
    setRule<K extends `${keyof Rules & string}`>(name: K, options?: Rule | RuleOptions): this;
}
