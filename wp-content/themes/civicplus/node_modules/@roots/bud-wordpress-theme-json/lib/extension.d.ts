import type { Options, Schema } from '@roots/wordpress-theme-json-webpack-plugin';
 ...
 */
interface Mutator {
    (json: Container<Partial<Schema.SettingsAndStyles['settings']>> | Partial<Schema.SettingsAndStyles['settings']>): Container<Partial<Schema.SettingsAndStyles['settings']>> | Partial<Schema.SettingsAndStyles['settings']>;
}
...
declare class WordPressThemeJSON extends Extension<Options, ThemeJsonWebpackPlugin> implements Api {
    customTemplates: Api['customTemplates'];
    ...
    styles: Api['styles'];
    templateParts: Api['templateParts'];
    version: Api['version'];
    settings(input?: boolean | Container<Partial<Schema.SettingsAndStyles['settings']>> | Mutator | Partial<Schema.SettingsAndStyles['settings']>, raw?: boolean): this;
}
