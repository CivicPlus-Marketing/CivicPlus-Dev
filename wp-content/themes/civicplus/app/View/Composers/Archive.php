...
class Archive extends Composer {
	...
	public function get_archive_data() {
		if ( $this->post_type ) {
			if ( $this->post_type['type'] == 'home' || $this->post_type['type'] == 'archive' ) {
				...
				return get_field( 'hero', 'category_' . $this->post_type['id'] );
	...
	public function get_args() {
		if ( $this->post_type ) {
			if($this->post_type['type'] == 'resources'){
				return getArgs($this->post_type['name'], $this->posts_per_page, array('category', 'brochures-category', 'white-papers-category', 'webinars-category', 'ebooks-category', 'fact-sheets-category', 'tool-kit-category', 'infographics-category', 'videos-category', 'news-category'));
			} elseif ( $this->post_type['type'] == 'home' || $this->post_type['type'] == 'archive' ) {
				...
				return getArgs($this->post_type['name'], $this->posts_per_page, $this->post_type['tax_type'], $this->post_type['tax']);
			}
		}
